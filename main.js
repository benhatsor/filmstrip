...
// relative width and height of screen
...
function moveElem( e ) {
	...
	// get x and y of mouse ( minus header and sidebar )
	
	var currentX = e.clientX - 55;
	var currentY = e.clientY - 105;

	// change x and y of draggable element
	...
	// change x and y of frame preview
...
function openFrame( index ) {
	...
	// move draggable element to x and y of frame
	...
	// if playing animation, don't transition draggable
...
// utility function to select all text in node
...
document.querySelector( '.play' ).addEventListener( 'click', () => {
	...
	if ( document.querySelector( '.play' ).classList.contains( 'playing' ) ) {
		...
		// end animation at selected frame
...
var down = false;
document.querySelector( '.canvas' ).onmousedown = () => {
